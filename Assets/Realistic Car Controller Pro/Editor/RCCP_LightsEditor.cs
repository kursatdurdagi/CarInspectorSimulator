...
public class RCCP_LightsEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("lowBeamHeadlights"), new GUIContent("Low Beam Headlights"), false);
        EditorGUILayout.PropertyField(serializedObject.FindProperty("highBeamHeadlights"), new GUIContent("High Beam Headlights"), false);
        EditorGUILayout.PropertyField(serializedObject.FindProperty("indicatorsAll"), new GUIContent("Indicators"), false);
                ...
                if (prop.lights[i] != null) {
                    ...
                    if (GUILayout.Button("X")) {
                        ...
                        if (isPrefab) {
                            ...
                            bool unpackPrefab = EditorUtility.DisplayDialog("Realistic Car Controller Pro | Unpacking Prefab", "This vehicle is connected to a prefab. In order to remove this light, you'll need to unpack the prefab connection first.", "Unpack", "Cancel");
                        ...
                        bool confirm = EditorUtility.DisplayDialog("Realistic Car Controller Pro | Removing Light", "Are you sure you want to remove this light? You can't undo this operation.", "Remove", "Cancel");
