...
public class RCCP_CreateNewVehicle {
    ...
    public static RCCP_CarController NewVehicle(GameObject vehicle, RCCP_SetupWizardController.SetupData setupData) {
        ...
        // Use pre-made decisions from the wizard (no dialog popups)
        if (setupData.isPrefab && setupData.unpackPrefab)
            PrefabUtility.UnpackPrefabInstance(vehicle, PrefabUnpackMode.Completely, InteractionMode.AutomatedAction);

        if (setupData.hasExistingRigidbodies && setupData.removeExistingRigidbodies) {
        ...
        if (setupData.hasExistingWheelColliders && setupData.removeExistingWheelColliders) {
    ...
    public static void ApplyEngineSettings(RCCP_CarController prop, RCCP_SetupWizardController.SetupData setupData) {
    ...
    public static void ApplyHandlingSettings(RCCP_CarController prop, RCCP_SetupWizardController.SetupData setupData) {
        ...
        switch (setupData.handlingType) {
            ...
            case RCCP_SetupWizardController.HandlingType.Realistic:
            ...
            case RCCP_SetupWizardController.HandlingType.Balanced:
            ...
            case RCCP_SetupWizardController.HandlingType.Stable:
    ...
    public static void ApplyDifferentialSettings(RCCP_CarController prop, RCCP_SetupWizardController.SetupData setupData) {
    ...
    public static void ApplyWheelColliderSettings(RCCP_CarController prop, RCCP_SetupWizardController.SetupData setupData) {
        ...
        switch (setupData.wheelType) {
            ...
            case RCCP_SetupWizardController.WheelType.Realistic:
            ...
            case RCCP_SetupWizardController.WheelType.Balanced:
            ...
            case RCCP_SetupWizardController.WheelType.Stable:
            ...
            case RCCP_SetupWizardController.WheelType.Slippy:
                wheelFrictionCurve_F.extremumSlip = .4f;
                wheelFrictionCurve_F.extremumValue = 1f;
                wheelFrictionCurve_F.asymptoteSlip = .8f;
                wheelFrictionCurve_F.asymptoteValue = .5f;
    ...
    public static void AddAddonComponents(RCCP_CarController prop, RCCP_SetupWizardController.SetupData setupData) {
