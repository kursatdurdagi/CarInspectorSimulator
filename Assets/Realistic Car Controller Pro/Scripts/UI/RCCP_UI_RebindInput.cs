...
public class RCCP_UI_RebindInput : RCCP_UIComponent {
    ...
    /// <summary>Options controlling how the binding is displayed as text (e.g., short names, no control schemes).</summary>
    ...
    protected void OnEnable() {
        if (s_RebindActionUIs == null)
            s_RebindActionUIs = new List<RCCP_UI_RebindInput>();
    ...
    [Tooltip("GUID of the specific binding on the action to rebind.")]
    [SerializeField]
    private string m_BindingId;

    [Tooltip("Formatting options for how the binding is displayed as text in the UI.")]
    [SerializeField]
    ...
    private static List<RCCP_UI_RebindInput> s_RebindActionUIs;
    ...
    /// <summary>UnityEvent invoked when the binding display text needs to be refreshed.</summary>
    [Serializable]
    public class UpdateBindingUIEvent : UnityEvent<RCCP_UI_RebindInput, string, string, string> {
    }

    /// <summary>UnityEvent invoked when an interactive rebind operation completes.</summary>
    [Serializable]
