...
public class RCCP_Exterior_Cameras : RCCP_Component {
    ...
    /// </summary>
    [Tooltip("Reference to the hood/interior camera used for first-person driving perspective.")]
    ...
    /// </summary>
    [Tooltip("Reference to the wheel camera used for close-up wheel shots.")]
