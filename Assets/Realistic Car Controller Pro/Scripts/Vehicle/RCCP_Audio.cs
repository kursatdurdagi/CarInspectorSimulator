...
public class RCCP_Audio : RCCP_Component {
    ...
    public class EngineSound {
        ...
        /// </summary>
        [Tooltip("Audio clip for throttle-on (accelerating) engine sound.")]
    ...
    /// </summary>
    [Tooltip("Engine sound layers for different RPM ranges (idle, low, medium, high).")]
    ...
    public class EngineStart {
        ...
        /// </summary>
        [Tooltip("Audio clip played during engine ignition/cranking.")]
        public AudioClip audioClips;

        /// <summary>
        /// Local position offset for 3D audio positioning.
        /// </summary>
        [Tooltip("Local position offset for 3D spatial audio placement.")]
        public Vector3 localPosition = new Vector3(0f, 0f, 1.5f);

        /// <summary>
        /// Minimum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance within which the startup sound plays at full volume.")]
        public float minDistance = 5f;

        /// <summary>
        /// Maximum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance beyond which the startup sound is inaudible.")]
        public float maxDistance = 65f;

        /// <summary>
        /// Maximum volume for the startup sound.
        /// </summary>
        [Range(0f, 1f), Tooltip("Peak volume level for the engine startup sound.")]
        public float maxVolume = 1f;
    ...
    /// </summary>
    [Tooltip("Engine startup/ignition sound configuration.")]
    ...
    public class GearboxSound {
        ...
        /// </summary>
        [Tooltip("Array of gear shift sound clips; a random one is played on each shift.")]
        public AudioClip[] audioClips;
        ...
        /// </summary>
        [Tooltip("Local position offset for 3D spatial audio placement.")]
        public Vector3 localPosition = new Vector3(0f, -.25f, .5f);

        /// <summary>
        /// Minimum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance within which the gear shift sound plays at full volume.")]
        public float minDistance = 3f;

        /// <summary>
        /// Maximum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance beyond which the gear shift sound is inaudible.")]
        public float maxDistance = 15f;

        /// <summary>
        /// Maximum volume for gear shift sounds.
        /// </summary>
        [Range(0f, 1f), Tooltip("Peak volume level for gear shift sounds.")]
        public float maxVolume = 1f;
    ...
    /// </summary>
    [Tooltip("Gear shifting sound configuration.")]
    ...
    public class CrashSound {
        ...
        /// </summary>
        [Tooltip("Array of impact sound clips; a random one is selected per collision.")]
        public AudioClip[] audioClips;
        ...
        /// Minimum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance within which the crash sound plays at full volume.")]
        public float minDistance = 10f;

        /// <summary>
        /// Maximum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance beyond which the crash sound is inaudible.")]
        public float maxDistance = 100f;

        /// <summary>
        /// Maximum volume for crash sounds.
        /// </summary>
        [Range(0f, 1f), Tooltip("Peak volume level for collision impact sounds.")]
        public float maxVolume = 1f;
    ...
    /// </summary>
    [Tooltip("Collision impact sound configuration.")]
    ...
    public class ReverseSound {
        ...
        /// </summary>
        [Tooltip("Looping audio clip for the reverse gear warning beep.")]
        public AudioClip audioClips;
        ...
        /// Minimum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance within which the reverse beep plays at full volume.")]
        public float minDistance = 5f;

        /// <summary>
        /// Maximum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance beyond which the reverse beep is inaudible.")]
        public float maxDistance = 60f;

        /// <summary>
        /// Minimum pitch for slower reverse speeds.
        /// </summary>
        [Min(0f), Tooltip("Lowest pitch of the reverse beep at slow reverse speeds.")]
        public float minPitch = .8f;

        /// <summary>
        /// Maximum pitch for faster reverse speeds.
        /// </summary>
        [Min(0f), Tooltip("Highest pitch of the reverse beep at fast reverse speeds.")]
        public float maxPitch = 1f;

        /// <summary>
        /// Maximum volume for reverse warning.
        /// </summary>
        [Range(0f, 1f), Tooltip("Peak volume level for the reverse warning beep.")]
    ...
    /// </summary>
    [Tooltip("Reverse gear warning beep configuration.")]
    ...
    public class WindSound {
        ...
        /// </summary>
        [Tooltip("Looping audio clip for aerodynamic wind noise at high speed.")]
        public AudioClip audioClips;
        ...
        /// Minimum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance within which wind noise plays at full volume.")]
        public float minDistance = 5f;

        /// <summary>
        /// Maximum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance beyond which wind noise is inaudible.")]
        public float maxDistance = 50f;

        /// <summary>
        /// Maximum volume for wind noise.
        /// </summary>
        [Range(0f, 1f), Tooltip("Peak volume level for aerodynamic wind noise.")]
        public float maxVolume = .1f;
    ...
    /// </summary>
    [Tooltip("Wind noise configuration for high-speed effects.")]
    ...
    public class BrakeSound {
        ...
        /// </summary>
        [Tooltip("Looping audio clip for the brake squeal/screech effect.")]
        public AudioClip audioClips;
        ...
        /// Minimum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance within which the brake squeal plays at full volume.")]
        public float minDistance = 10f;

        /// <summary>
        /// Maximum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance beyond which the brake squeal is inaudible.")]
        public float maxDistance = 100f;

        /// <summary>
        /// Maximum volume for brake sounds.
        /// </summary>
        [Range(0f, 1f), Tooltip("Peak volume level for brake squeal sounds.")]
        public float maxVolume = .25f;
    ...
    /// </summary>
    [Tooltip("Brake squeal sound configuration.")]
    ...
    public class NosSound {
        ...
        /// </summary>
        [Tooltip("Looping audio clip for the nitrous oxide hiss while boost is active.")]
        public AudioClip audioClips;
        ...
        /// Minimum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance within which the NOS sound plays at full volume.")]
        public float minDistance = 5f;

        /// <summary>
        /// Maximum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance beyond which the NOS sound is inaudible.")]
        public float maxDistance = 70f;

        /// <summary>
        /// Maximum volume for NOS sound.
        /// </summary>
        [Range(0f, 1f), Tooltip("Peak volume level for the nitrous oxide activation sound.")]
        public float maxVolume = 1f;
    ...
    /// </summary>
    [Tooltip("Nitrous oxide (NOS) activation sound configuration.")]
    ...
    public class TurboSound {
        ...
        /// </summary>
        [Tooltip("Looping audio clip for the turbocharger spool/whine sound.")]
        public AudioClip audioClips;
        ...
        /// Minimum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance within which the turbo spool plays at full volume.")]
        public float minDistance = 5f;

        /// <summary>
        /// Maximum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance beyond which the turbo spool is inaudible.")]
        public float maxDistance = 50f;

        /// <summary>
        /// Maximum volume for turbo sound.
        /// </summary>
        [Range(0f, 1f), Tooltip("Peak volume level for the turbocharger spool sound.")]
    ...
    /// </summary>
    [Tooltip("Turbocharger spool/whine sound configuration.")]
    ...
    public class ExhaustFlameSound {
        ...
        /// </summary>
        [Tooltip("Array of exhaust backfire/pop clips; a random one is played per pop event.")]
        public AudioClip[] audioClips;
        ...
        /// </summary>
        [Tooltip("Local position offset for 3D spatial audio placement.")]
        public Vector3 localPosition = new Vector3(0f, -.35f, -1.75f);

        /// <summary>
        /// Minimum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance within which the exhaust pop plays at full volume.")]
        public float minDistance = 5f;

        /// <summary>
        /// Maximum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance beyond which the exhaust pop is inaudible.")]
        public float maxDistance = 80f;

        /// <summary>
        /// Maximum volume for exhaust pops.
        /// </summary>
        [Range(0f, 1f), Tooltip("Peak volume level for exhaust backfire pops.")]
        public float maxVolume = 1f;
    ...
    /// </summary>
    [Tooltip("Exhaust backfire/pop sound configuration.")]
    ...
    public class BlowSound {
        ...
        /// </summary>
        [Tooltip("Array of blow-off valve clips; a random one is played on each pressure release.")]
        public AudioClip[] audioClips;
        ...
        /// </summary>
        [Tooltip("Local position offset for 3D spatial audio placement.")]
        public Vector3 localPosition = new Vector3(0f, -.2f, -1.5f);

        /// <summary>
        /// Minimum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance within which the blow-off sound plays at full volume.")]
        public float minDistance = 3f;

        /// <summary>
        /// Maximum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance beyond which the blow-off sound is inaudible.")]
        public float maxDistance = 20f;

        /// <summary>
        /// Maximum volume for blow-off sound.
        /// </summary>
        [Range(0f, 1f), Tooltip("Peak volume level for the turbo blow-off valve sound.")]
        public float maxVolume = .2f;
    ...
    /// </summary>
    [Tooltip("Turbo blow-off valve release sound configuration.")]
    ...
    public class DeflateSound {
        ...
        /// </summary>
        [Tooltip("One-shot audio clip played when a tire is punctured or deflated.")]
        public AudioClip audioClips;
        ...
        /// Minimum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance within which the deflation sound plays at full volume.")]
        public float minDistance = 5f;

        /// <summary>
        /// Maximum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance beyond which the deflation sound is inaudible.")]
        public float maxDistance = 25f;

        /// <summary>
        /// Maximum volume for deflation sound.
        /// </summary>
        [Range(0f, 1f), Tooltip("Peak volume level for the tire deflation sound.")]
        public float maxVolume = 1f;
    ...
    /// </summary>
    [Tooltip("Tire puncture/deflation sound configuration.")]
    ...
    public class InflateSound {
        ...
        /// </summary>
        [Tooltip("One-shot audio clip played when a tire is repaired or inflated.")]
        public AudioClip audioClips;
        ...
        /// Minimum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance within which the inflation sound plays at full volume.")]
        public float minDistance = 5f;

        /// <summary>
        /// Maximum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance beyond which the inflation sound is inaudible.")]
        public float maxDistance = 25f;

        /// <summary>
        /// Maximum volume for inflation sound.
        /// </summary>
        [Range(0f, 1f), Tooltip("Peak volume level for the tire inflation sound.")]
        public float maxVolume = 1f;

        /// <summary>
        /// Tracks the last inflation state.
        /// </summary>
        [Tooltip("Tracks the previous inflation state to detect changes.")]
    ...
    /// </summary>
    [Tooltip("Tire repair/inflation sound configuration.")]
    ...
    public class FlatSound {
        ...
        /// </summary>
        [Tooltip("Looping audio clip for the rhythmic thump of a flat tire rolling.")]
        public AudioClip audioClips;
        ...
        /// Minimum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance within which the flat tire sound plays at full volume.")]
        public float minDistance = 5f;

        /// <summary>
        /// Maximum distance for 3D audio attenuation.
        /// </summary>
        [Min(0f), Tooltip("Distance beyond which the flat tire sound is inaudible.")]
        public float maxDistance = 50f;

        /// <summary>
        /// Maximum volume for flat tire sound.
        /// </summary>
        [Range(0f, 1f), Tooltip("Peak volume level for the flat tire rolling sound.")]
        public float maxVolume = 1f;
    ...
    /// </summary>
    [Tooltip("Flat tire rolling sound configuration.")]
    ...
    /// </summary>
    /// <returns>Array of all RCCP_AudioSource components attached to this vehicle.</returns>
    ...
    private void Engine() {
        ...
        if (engineSounds != null && engineSounds.Length >= 1) {
            ...
            // Find the engine sound with the highest maxRPM (the redline clip)
            EngineSound highestRPMSound = null;

            foreach (EngineSound s in engineSounds) {

                if (s != null && (highestRPMSound == null || s.maxRPM > highestRPMSound.maxRPM))
                    highestRPMSound = s;
            ...
            foreach (EngineSound es in engineSounds) {
                ...
                float baseVolume = 0f;
                bool isHighestRPMSound = (es == highestRPMSound);
                ...
                if (rpm >= es.minRPM && rpm <= es.maxRPM) {
                    ...
                    if (isHighestRPMSound) {

                        // Half bell: fade in from 0 to 1 over first half, hold at 1 for second half
                        float halfBell = position < 0.5f
                            ? 1f - Mathf.Pow(2f * position - 1f, 2f)
                            : 1f;
                        baseVolume = es.maxVolume * halfBell;

                    } else {

                        // Full bell curve for crossfading layers
                    ...
                    if (isHighestRPMSound) {
                        ...
                        // Highest RPM sound holds at full volume above max RPM (redline)
                        baseVolume = es.maxVolume;
