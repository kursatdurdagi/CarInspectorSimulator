...
public class RCCP_WheelSlipParticles : RCCP_Component {
    ...
    public ParticleSystem WheelParticles {
        ...
        get {
            ...
            if (!wheelParticles)
                TryGetComponent(out wheelParticles);
    ...
    [Tooltip("Minimum particle emission rate at low slip intensity.")]
    [Range(0f, 100f)] public float minEmissionRate = 2.5f;
    [Tooltip("Maximum particle emission rate at full slip intensity.")]
