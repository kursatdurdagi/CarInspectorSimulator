...
public class RCCP_Lod : RCCP_Component {
    ...
    /// </summary>
    [Tooltip("Forces LOD level 0 (full detail) regardless of camera distance.")]
    ...
    /// </summary>
    [Tooltip("Forces LOD level 2 (reduced detail) regardless of camera distance.")]
    public bool forceToLatestLevel = false;

    /// <summary>
    /// Current LOD level [0..3]. Level 0 = full detail, 1..3 progressively disable more components.
    /// </summary>
    [Tooltip("Active LOD tier (0 = full detail, 3 = minimal); set automatically by distance.")]
    ...
    /// </summary>
    [Tooltip("Scales all LOD distance thresholds; lower values trigger reduced detail sooner.")]
