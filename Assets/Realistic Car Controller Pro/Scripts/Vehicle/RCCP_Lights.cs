...
public class RCCP_Lights : RCCP_Component {
    ...
    /// </summary>
    [Tooltip("List of all RCCP_Light components on this vehicle (headlights, taillights, indicators, etc).")]
